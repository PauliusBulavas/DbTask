    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentDboLectureDbo", x => new { x.DepartmentsId, x.LecturesId });
                    table.ForeignKey(
                        name: "FK_DepartmentDboLectureDbo_Departments_DepartmentsId",
                        column: x => x.DepartmentsId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentDboLectureDbo_Lectures_LecturesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentDboLectureDbo_LecturesId",
                table: "DepartmentDboLectureDbo",
                column: "LecturesId");
